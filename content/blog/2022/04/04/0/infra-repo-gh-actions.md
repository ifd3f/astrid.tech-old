...
description: "#2 will make you want to vomit because it certainly did for me"
date: 2022-04-04 15:45:04-07:00
ordinal: 0
tags:
...
Sadly so I spent the weekend hacking on it for a while. Here is a summary of all
the hacks I ended up using.
[For reference, here is a permalink to my workflows directory at the time of writing.](https://github.com/astralbijection/infra/tree/ccc968dc1d8e494b64b6f2a3827d712f2a259812/.github/workflows)

## 1. Dynamic job matrices for dynamic amounts of fun

Here is a job spec from my
[original pipeline](https://github.com/astralbijection/infra/blob/70007f6d9b67f817dfa36249fdd53333ed5dd819/.github/workflows/nix-flake-check.yml):
...
[the Nix derivation shown here](https://github.com/astralbijection/infra/blob/ccc968dc1d8e494b64b6f2a3827d712f2a259812/pkgs/gh-ci-matrix/default.nix).
...
[and that's something they do on purpose](https://github.community/t/triggering-a-new-workflow-from-another-workflow/16250).
...
[Here is the flake bump workflow after all these changes.](https://github.com/astralbijection/infra/blob/01ac0240072e3e40515f0b2882aa6ffc273ebbe2/.github/workflows/periodic-bump.yml)
...
all, the checkmark would finally be correct, yes?

![]()

Well turns out it's _still_ not showing the status of my nix build, even though
I ran it on that sha.
...
But I suppose on the bright side, my CI pipeline looks extremely complicated and
